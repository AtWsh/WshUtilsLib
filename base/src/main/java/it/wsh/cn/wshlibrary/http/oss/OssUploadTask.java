...
import it.wsh.cn.wshlibrary.http.utils.MainThreadExecutor;
    ...
    public void start(IProcessListener listener) {
        ...
        request.setProgressCallback(new OSSProgressCallback<PutObjectRequest>() {
            ...
            public void onProgress(PutObjectRequest request, long currentSize, long totalSize) {
                HttpLog.i("ossUploadFile onProgress request: " + mObjectKey + " currentSize: " + currentSize + " totalSize: " + totalSize);
        ...
        mOSSAsyncTask = mOss.asyncPutObject(request, new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
                HttpLog.i("OssUploadTask: ossUploadFile onSuccess request: " + mObjectKey);
            ...
            public void onFailure(PutObjectRequest request, ClientException clientException, ServiceException serviceException) {
                ...
                HttpLog.e("OssUploadTask: ossUploadFile onFailure request: " + mObjectKey);
                // 请求异常
                if (clientException != null) {
                    // 本地异常如网络异常等
                    HttpLog.e("OssUploadTask: ossUploadFile onFailure");
                ...
                if (serviceException != null) {
                    ...
                    HttpLog.e("OssUploadTask: ossUploadFile onFailure ErrorCode: " + errCode + " RequestId: "
