 ...
 * description:
 */
public abstract class BaseUploadReqInfo extends BaseReqInfo {
     ...
     * @param des
     */
    public BaseUploadReqInfo addImgAndDescribe(File file, String des) {
        if (file == null) {
     ...
     * @param des
     */
    public BaseUploadReqInfo addImgAndDescribe(String fileKey, File file, String desKey, String des) {
    ...
    public BaseUploadReqInfo addFile(File file) {
        if (file == null) {
            return null;
        }
    ...
    public BaseUploadReqInfo addFile(String key, File file) {
        if (file == null) {
            return null;
        }
    ...
    public BaseUploadReqInfo addFile(String key, String filePath) {
    ...
    public BaseUploadReqInfo addFiles(List<File> files) {
    ...
    public BaseUploadReqInfo addPartMap(Map<String, RequestBody> partMap) {
        if (partMap == null) {
