            ...
            public int compare(Object obj1, Object obj2) {
                ...
                try {
                    ...
                    if (sortMode != null && "desc".equals(sortMode)) {
                         ...
                         */
                        result = method2.invoke(obj2).toString()
                                .compareTo(method1.invoke(obj1).toString()); // 倒序
                    } else {
                        result = method1.invoke(obj1).toString()
                                .compareTo(method2.invoke(obj2).toString()); // 正序
                    }
                } catch (Exception e) {
