...
public class DownloadTestActivity2 extends AppCompatActivity {
    ...
    public static void luanchActivity(Activity context) {
        Intent intent = new Intent(context, DownloadTestActivity2.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(DownloadTestActivity2.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                // Should we show an explanation?
                if (ActivityCompat.shouldShowRequestPermissionRationale(DownloadTestActivity2.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
...
//                            ActivityCompat.requestPermissions(getActivity(), new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_EXTERNAL_STORAGE_REQUEST_CODE);
    ...
    private void initView() {
        ...
        mResumeBtn1 = findViewById(R.id.tv_resume1);
    ...
    private void initAction() {
        ...
        mResumeBtn1.setOnClickListener(mResumeClickListener1);
    ...
    private View.OnClickListener mResumeClickListener1 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            DownloadHelper.getInstance().resumeDownload(mId1);
        }
    };
    ...
    private View.OnClickListener mDeleteClickListener1 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            DownloadHelper.getInstance().remove(mId1);
        }
    };
    ...
    private View.OnClickListener mDeleteClickListener2 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            DownloadHelper.getInstance().remove(mId2);
        }
    };
    ...
    private View.OnClickListener mDeleteClickListener3 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            DownloadHelper.getInstance().remove(mId3);
        }
    };
    ...
    private View.OnClickListener mPauseClickListener1 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            DownloadHelper.getInstance().pause(mId1);
        }
    };
    ...
    private View.OnClickListener mPauseClickListener2 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            DownloadHelper.getInstance().pause(mId2);
        }
    };
    ...
    private View.OnClickListener mPauseClickListener3 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            DownloadHelper.getInstance().pause(mId3);
        }
    };
    ...
    private View.OnClickListener mDownloadClickListener1 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            mId1 = DownloadHelper.getInstance().start(mDownloadUrl1, "测试1.apk");
            DownloadHelper.getInstance().addListener(mId1, new IDownloadListener() {
                @Override
    ...
    private View.OnClickListener mDownloadClickListener2 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            mId2 = DownloadHelper.getInstance().start(mDownloadUrl2, "测试2.apk");
            DownloadHelper.getInstance().addListener(mId2, new IDownloadListener() {
                @Override
                public void progress(int progress) {
    ...
    private View.OnClickListener mDownloadClickListener3 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            mId3 = DownloadHelper.getInstance().start(mDownloadUrl3, "测试3.apk");
            DownloadHelper.getInstance().addListener(mId3, new IDownloadListener() {
                @Override
                public void progress(int progress) {
