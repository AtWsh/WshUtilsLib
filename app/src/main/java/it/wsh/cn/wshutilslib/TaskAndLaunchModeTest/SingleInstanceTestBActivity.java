...
public class SingleInstanceTestBActivity extends AppCompatActivity {

    public static final String TAG = "wsh_log_SingleInsTestB";
    ...
    public static void startSelf(Context context) {
        ...
        Intent intent = new Intent(context, SingleInstanceTestBActivity.class);
    ...
    private void initAction() {
        mBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SingleInstanceTestCActivity.startSelf(SingleInstanceTestBActivity.this);
            }
        });
    }
