...
public class StatusBarUtil {
     ...
     * @return
     */
    public static void setStatusBarDarMode(Activity activity,@ColorRes int colorRes) {
    ...
    /** 增加View的marginTop,增加的值为状态栏高度 (智能判断，并设置高度)  只有父布局为线性布局才能使用*/
    public static void setTopMarginSmart(Context context, View view) {
